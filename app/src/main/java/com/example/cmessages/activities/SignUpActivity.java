...
import com.example.cmessages.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private Boolean isValidSignUpDetails(){
        if(encodedImage == null){
            ...
            return false;
        }else if(!binding.inputPassword.getText().toString().equals(binding.confirmInputPassword.getText().toString())){
