...
import com.example.cmessages.adapters.RecentConversationsAdapter;
import com.example.cmessages.databinding.ActivityMainBinding;
import com.example.cmessages.listeners.ConversionListener;
import com.example.cmessages.models.ChatMessage;
import com.example.cmessages.models.User;
...
public class MainActivity extends BaseActivity implements ConversionListener {
        ...
        if (value != null){
            for (DocumentChange documentChange : value.getDocumentChanges()){
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    }else {chatMessage.conversionImage = documentChange.getDocument().getString(Constants.KEY_SENDER_IMAGE);
    ...
    private void updateToken(String token) {
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                .addOnSuccessListener(unused -> showToast("Welcome back!"))
    ...
    private void signOut(){
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e -> showToast("Failed to log out"));
    }
